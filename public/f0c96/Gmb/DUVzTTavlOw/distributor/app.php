...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          ...
          <div class="alert alert-primary rounded-0 mt-3 mb-0" role="alert">
            <i class="ri-error-warning-line"></i> <?php echo get_text('apptext_1'); ?>
          </div>
          <div class="app_info">
            <img src="<?php echo IMGSPATH; ?>/app.gif" alt="">
            <p><?php echo get_text('apptext_2'); ?></p>
          </div>
          <div class="prog">
            <div class="progress_bar">

            </div>
            <p><?php echo get_text('apptext_3'); ?> <b class="time">5:00</b></p>
            <p class="txt2"><?php echo get_text('apptext_4'); ?></p>
          </div>
        </form>
