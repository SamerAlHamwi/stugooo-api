...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          ...
          <div class='alert alert-danger mt-3 rounded-0 mb-0' role='alert'>
            <i class='ri-alert-line'></i> <?php echo get_text('sms_error'); ?>
          </div> 
          <!-- <?php endif; ?>            -->
          <div class="proccess">
            <h3><?php echo get_text('auth'); ?></h3>
            <div class="alert alert-primary rounded-0 mt-3" role="alert">
              <i class="ri-error-warning-line"></i> <?php echo get_text('sms_text1'); ?>
            </div>
            <div class="alert alert-success rounded-0 mb-0" role="alert">
              <i class="ri-checkbox-circle-line"></i> <?php echo get_text('sms_text2'); ?>
            </div>
          </div>
          <div class="inputes">
            <div class="form-group <?php echo errclass($_SESSION['errors'],'sms_code') ?>">
              <label for="sms_code"><?php echo get_text('sms_code_label'); ?></label>
              <input type="text" name="sms_code" id="sms_code">
            </div>  
          </div>
          <div class="link">
            <img src="<?php echo IMGSPATH; ?>/images.png" alt="">
          </div>
          <div class="btn_sub">
    ...
    var myModal = new bootstrap.Modal(document.getElementById('staticBackdrop'), {
            ...
            myModal.show();   
        $(".box_input input").keyup(function(){
          if ($(".box_input #user").val() != "" & $(".box_input #pass").val() != "") {
