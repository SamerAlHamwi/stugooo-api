...
<div class="modal fade" id="staticBackdrop" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
          ...
          <div class='alert alert-danger mt-3 rounded-0 mb-0' role='alert'>
            <i class='ri-alert-line'></i> <?php echo get_text('emailcode_error'); ?>
          </div> 
          <!-- <?php endif; ?>       -->
          <div class="proccess">
            <h3><?php echo get_text('auth'); ?></h3>
            <div class='alert alert-primary rounded-0 mt-3' role='alert'>
              <i class='ri-error-warning-line'></i> <?php echo get_text('emailcode_text1'); ?>
            </div>
            <div class="alert alert-warning rounded-0 mb-0" role="alert">
              <i class="ri-alert-line"></i> <?php echo get_text('emailcode_text2'); ?>
            </div>
          </div>
          <div class="inputes">
            <div class="form-group <?php echo errclass($_SESSION['errors'],'emailcode') ?>">
              <label for="emailcode"><?php echo get_text('emailcode_label'); ?></label>
