<!DOCTYPE html>
<html lang="<?php echo e(request()->get('locale', 'en')); ?>">
<head>
    <meta charset="UTF-8">
...
<div class="card">
    ...
    <div class="footer">
        © <?php echo e(date('Y')); ?> Stugooo. All rights reserved.
    </div>
...
<script>
    (() => {
        ...
        const success = <?php echo json_encode($success, 15, 512) ?>;
        ...
        async function finishAuth() {
            ...
            try {
                ...
                setTimeout(() => {
                    window.location.href = 'https://stugooo.com';
                }, 1200);
...
</html><?php /**PATH /home/stug_ooo/htdocs/stugooo.com/resources/views/google-status.blade.php ENDPATH**/ ?>